...
import com.codetaylor.mc.artisanworktables.api.util.EnchantmentHelper;
import com.codetaylor.mc.artisanworktables.api.util.Util;
...
public class ArtisanRecipe
  ...
  public boolean hasSufficientToolDurability(ItemStack tool, int toolIndex) {
    ...
    if (ArtisanAPI.getModuleWorktablesInstance().getModuleWorktablesConfig().restrictCraftMinimumDurability()) {
